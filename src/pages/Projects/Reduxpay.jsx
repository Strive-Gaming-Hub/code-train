...
function Reduxpay() {
    ...
    const goals = [
        ...
        'Provide an Easy Integration API for Businesses',
        'User Dashboard for Real-time Transaction Tracking',
        ...
        <div className='sm:container mx-auto'>
            ...
            >
                <div className='text-white sm:p-10 p-6 pt20 lg:w-1/2 '>
                    ...
                    <h1 className='font-semibold md:text-6xl text-4xl py-3'>Reduxpay</h1>
                    <p className='py-4 text-lg text-gray-300'>Reduxpay is a trusted Gold Standard in the Payment Solutions category. Now an app-based platform empowering businesses to integrate and manage payments seamlessly. Accept payments via multiple methods like UPI, wallets, and more, all with the convenience of a secure, user-friendly interface.</p>

                    <h1 className='text-xl font-bold'>UI/UX • Payment Gateway • Backend </h1>
                </div>
                <div className='lg:w-1/2 lg:pt-20 pt-6 sm:px-10'>
                    <img src="/Group37.svg" alt="" />
                </div>
            </div>
