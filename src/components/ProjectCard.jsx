...
const ProjectCard = ({ clientName, description, services, img, reverse }) => {
    return (
        <div className={`rounded-xl border border-[#211f37] sm:m-8 m-4 lg:gap-10 gap-4  flex ${reverse %2 !== 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} flex-col justify-between overflow-hidden`}
