...
import './card.css'; // Make sure this file contains the CSS above
...
const ServiceCard = ({ img, title, desc }) => {
    ...
    return (
        <div>
            <div
                ref={cardRef}
                className={`card group border-[.1px] border-[#276bf30c] shadow-blue-500 shadow-[0px_0px_10px_-8px_rgba(0,_0,_0,_0.1)] p-5 text-center w-[20rem] rounded-2xl min-h-[2rem] relative z-50 overflow-hidden ${isVisible ? 'animate' : ''
                    }`}
